...
namespace BeadBE.Api.Common.Errors
{
    public class BeadProblemDetailsFactory : ProblemDetailsFactory
    {
        private readonly ApiBehaviorOptions _options;

        public BeadProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
        {
